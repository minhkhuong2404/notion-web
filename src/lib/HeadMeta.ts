...
const HeadMeta = (options: any, head : any) => {
    ...
    let siteName =  settings?.site_name ?? "Khuong Lu"; 
    let siteDescription = head?.description ?? settings?.site_description ?? "Khuong Lu là một blog về phát triển web, lập trình và công nghệ.";
